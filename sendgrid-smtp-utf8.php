...
$message = Swift_Message::newInstance()
  ->setSubject("[sendgrid-smtp-php-example] フクロウのお名前は fullname さん")
  ->setTo("dummy@test.com")
  ->setFrom($from)
  ->setBody("familyname さんは何をしていますか？\r\n 彼はplaceにいます。", "text/plain; charset=UTF-8")
  ->addPart("<strong> familyname さんは何をしていますか？</strong><br />彼はplaceにいます。", "text/html; charset=UTF-8")
  ->attach($attachment);
